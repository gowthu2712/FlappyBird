...
class FlappyBird(PyGameWrapper):
    ...
    def getGameState(self):
        ...
        return image_data,self.getScore(),self.game_over()
...
class GameState:
    ...
    def frame_step(self,action):
        #dt = self.game.clock.tick_busy_loop(30)
        #print(dt)
        if action == 1:
            self.game.player.flapped = True
        else:
            self.game.player.flapped = False
        self.game.step(25)
        image_data,reward,terminal = self.game.getGameState()
